...
class MyTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black),

    titleLarge: const TextStyle().copyWith(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.black),
    titleMedium: const TextStyle().copyWith(fontSize: 16, fontWeight: FontWeight.bold, color: EColors.dotColor),
    titleSmall: const TextStyle().copyWith(fontSize: 16, fontWeight: FontWeight.w600, color: EColors.dotColor),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 13, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.5),),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 13, fontWeight: FontWeight.w500, color: EColors.primary),
